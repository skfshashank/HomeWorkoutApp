...
const EXERCISE_BUILDERS = {
  ...
  'reverse-crunches': () => {
    const kneesHalf = updatePose(LYING_BACK, {
      9: [0.67, 0.62], 10: [0.67, 0.82],
      11: [0.74, 0.52], 12: [0.74, 0.92],
      15: [0.78, 0.48], 16: [0.78, 0.96]
    });
    const kneesUp = updatePose(LYING_BACK_KNEES_UP, {
      7: [0.52, 0.64], 8: [0.52, 0.72],
      14: [0.52, 0.68]
    });
    return def('front', LYING_BACK, kneesHalf, LYING_BACK_KNEES_UP, kneesUp, reverseCrunchHigh, kneesUp, LYING_BACK_KNEES_UP, LYING_BACK);
  },
  'leg-raises': () => {
  ...
  'side-plank': () => {
    const hipDip = updatePose(SIDE_PLANK, {
      0: [0.55, 0.28],
      7: [0.46, 0.60],
      8: [0.48, 0.56],
      9: [0.35, 0.74],
    ...
    const armReach = updatePose(SIDE_PLANK, {
      0: [0.54, 0.22],
      4: [0.58, 0.16],
      6: [0.60, 0.04],
      13: [0.52, 0.32]
    });
    return def('side', SIDE_PLANK, hipDip, SIDE_PLANK, armReach, SIDE_PLANK, hipDip, SIDE_PLANK);
  },
  'plank-hip-dips': () => {
    const hipLeft = updatePose(PLANK_FRONT, { 7: [0.44, 0.62], 8: [0.54, 0.54], 14: [0.49, 0.58] });
    const hipRight = updatePose(PLANK_FRONT, { 7: [0.46, 0.54], 8: [0.56, 0.62], 14: [0.51, 0.58] });
    const hipLeftDeep = updatePose(hipLeft, { 7: [0.42, 0.66], 14: [0.48, 0.60] });
    const hipRightDeep = updatePose(hipRight, { 8: [0.58, 0.66], 14: [0.52, 0.60] });
    return def('front', PLANK_FRONT, hipLeft, hipLeftDeep, PLANK_FRONT, hipRight, hipRightDeep, PLANK_FRONT);
  },
  'mountain-climbers': () => {
  ...
  'v-ups': () => {
    const legsLift = updatePose(LYING_BACK, {
      9: [0.70, 0.60], 10: [0.70, 0.84],
      11: [0.78, 0.48], 12: [0.78, 0.96],
      15: [0.84, 0.40], 16: [0.84, 1.00]
    });
    const armsReach = updatePose(legsLift, {
      0: [0.26, 0.62], 3: [0.38, 0.56], 4: [0.38, 0.80],
  ...
  'dead-bug': () => {
    const deadBugPrepRight = updatePose(LYING_BACK_KNEES_UP, {
      3: [0.40, 0.58],
      5: [0.48, 0.54],
      10: [0.67, 0.88],
      12: [0.80, 0.96],
    ...
    return def(
      ...
      deadBugRight,
      LYING_BACK_KNEES_UP,
      mirrorPose(deadBugPrepRight),
      mirrorPose(deadBugRight),
      LYING_BACK_KNEES_UP
    );
  },
  'heel-taps': () => {
    const heelTapPrepLeft = updatePose(LYING_BACK_KNEES_UP, {
      0: [0.22, 0.64],
      3: [0.38, 0.58],
      4: [0.38, 0.76],
      5: [0.58, 0.50],
    ...
    return def(
      ...
      heelTapLeft,
      LYING_BACK_KNEES_UP,
      mirrorPose(heelTapPrepLeft),
      mirrorPose(heelTapLeft),
      LYING_BACK_KNEES_UP
    );
  },
  'toe-touches': () => {
  ...
  'plank-shoulder-taps': () => {
    const weightShiftRight = updatePose(PLANK_FRONT, {
      7: [0.47, 0.56],
      8: [0.57, 0.58],
      9: [0.47, 0.72],
      10: [0.57, 0.72],
    ...
    const tapLeft = updatePose(shoulderTapLeft, {
      7: [0.47, 0.56],
      8: [0.57, 0.58],
      9: [0.47, 0.72],
      10: [0.57, 0.72],
    ...
    return def('front', PLANK_FRONT, weightShiftRight, tapLeft, PLANK_FRONT, mirrorPose(weightShiftRight), mirrorPose(tapLeft), PLANK_FRONT);
  },
  'knee-to-elbow-plank': () => {
    const kneeDrivePrepLeft = updatePose(PLANK_SIDE, {
      9: [0.44, 0.66],
      11: [0.48, 0.60],
      15: [0.52, 0.58]
    });
    return def(
      ...
      plankKneeLeft,
      PLANK_SIDE,
      mirrorPose(kneeDrivePrepLeft),
      mirrorPose(plankKneeLeft),
      PLANK_SIDE
    );
  },
  'boat-hold': () => {
    const boatLegExtend = updatePose(boatReach, {
      9: [0.38, 0.46],
      10: [0.62, 0.46],
      11: [0.28, 0.32],
      12: [0.72, 0.32],
    ...
    const boatLeanBack = updatePose(boatReach, {
      0: [0.50, 0.23],
      1: [0.45, 0.35],
      2: [0.55, 0.35],
      3: [0.40, 0.38],
    ...
    return def('front', boatReach, boatLegExtend, boatReach, boatLeanBack, boatReach, boatLegExtend, boatReach);
  },
  'plank-jacks': () => EXERCISE_BUILDERS['plank-jacks-hiit'](),
  'burpees': () => {
    const handsDown = updatePose(burpeeSquat, {
      0: [0.50, 0.28],
      3: [0.44, 0.56],
      4: [0.56, 0.56],
      5: [0.42, 0.74],
    ...
    const jumpInSquat = updatePose(burpeeSquat, {
      0: [0.50, 0.22],
      3: [0.40, 0.50],
      4: [0.60, 0.50],
      5: [0.36, 0.68],
    ...
    const squatUp = updatePose(squatMid, {
      3: [0.40, 0.38],
      4: [0.60, 0.38],
      5: [0.36, 0.46],
      6: [0.64, 0.46]
    });
    return def('front', STANDING_FRONT, burpeeSquat, handsDown, PLANK_FRONT, jumpInSquat, squatUp, jumpReach, STANDING_FRONT);
  },
  'surya-namaskar': () => {
  ...
  'vajrasana': () => {
    const breatheIn = updatePose(VAJRASANA, {
      0: [0.50, 0.19], 1: [0.44, 0.31], 2: [0.56, 0.31],
      13: [0.50, 0.31], 14: [0.50, 0.57]
    });
    const breathePeak = updatePose(VAJRASANA, {
      0: [0.50, 0.18], 1: [0.43, 0.30], 2: [0.57, 0.30],
      3: [0.42, 0.44], 4: [0.58, 0.44],
      13: [0.50, 0.30], 14: [0.50, 0.56]
    });
    const breatheOut = updatePose(VAJRASANA, {
      0: [0.50, 0.21], 1: [0.46, 0.33], 2: [0.54, 0.33],
      13: [0.50, 0.33], 14: [0.50, 0.59]
    });
    return def('front', VAJRASANA, breatheIn, breathePeak, breatheIn, VAJRASANA, breatheOut, VAJRASANA);
  },
  'paschimottanasana': () => {
  ...
  'shavasana': () => {
    const inhale = updatePose(LYING_BACK, {
      1: [0.30, 0.64], 2: [0.30, 0.76],
      7: [0.54, 0.66], 8: [0.54, 0.78],
      13: [0.28, 0.68], 14: [0.54, 0.72]
    });
    const peak = updatePose(inhale, {
      0: [0.18, 0.69], 1: [0.30, 0.63], 2: [0.30, 0.77],
      3: [0.40, 0.62], 4: [0.40, 0.78],
      5: [0.50, 0.60], 6: [0.50, 0.80]
    });
    const exhale = updatePose(LYING_BACK, {
      0: [0.18, 0.71], 1: [0.30, 0.67], 2: [0.30, 0.75],
      13: [0.28, 0.71]
    });
    return def('side', LYING_BACK, inhale, peak, inhale, LYING_BACK, exhale, LYING_BACK);
  },
  'padmasana': () => {
    const breatheIn = updatePose(lotusPose, {
      0: [0.50, 0.21], 1: [0.43, 0.34], 2: [0.57, 0.34],
      13: [0.50, 0.34], 14: [0.50, 0.58]
    });
    const breathePeak = updatePose(lotusPose, {
      0: [0.50, 0.19], 1: [0.42, 0.33], 2: [0.58, 0.33],
      3: [0.38, 0.46], 4: [0.62, 0.46],
      13: [0.50, 0.33], 14: [0.50, 0.57]
    });
    const breatheOut = updatePose(lotusPose, {
      0: [0.50, 0.24], 1: [0.45, 0.37], 2: [0.55, 0.37],
      13: [0.50, 0.37], 14: [0.50, 0.61]
    });
    return def('front', lotusPose, breatheIn, breathePeak, breatheIn, lotusPose, breatheOut, lotusPose);
  },
  'kapalbhati': () => {
    const bellyIn = updatePose(SEATED_FRONT, {
      0: [0.50, 0.22], 1: [0.44, 0.35], 2: [0.56, 0.35],
      7: [0.47, 0.59], 8: [0.53, 0.59],
      13: [0.50, 0.35], 14: [0.50, 0.59]
    });
    const bellySnap = updatePose(bellyIn, {
      1: [0.45, 0.36], 2: [0.55, 0.36],
      7: [0.48, 0.60], 8: [0.52, 0.60],
      14: [0.50, 0.60]
    });
    const expand = updatePose(SEATED_FRONT, {
      0: [0.50, 0.22], 1: [0.43, 0.34], 2: [0.57, 0.34],
      7: [0.46, 0.58], 8: [0.54, 0.58],
      13: [0.50, 0.34], 14: [0.50, 0.58]
    });
    return def('front', SEATED_FRONT, expand, SEATED_FRONT, bellyIn, bellySnap, bellyIn, SEATED_FRONT);
  },
  'anulom-vilom': () => {
    ...
    return def('front', SEATED_FRONT, inhaleTall, nostrilLeft, SEATED_FRONT, inhaleTall, nostrilRight, SEATED_FRONT);
  },
  'bhramari': () => {
  ...
  'butt-kicks': () => {
    const weightShiftLeft = updatePose(STANDING_FRONT, {
      0: [0.48, 0.14],
      3: [0.42, 0.38],
      4: [0.58, 0.40],
      5: [0.38, 0.50],
    ...
    const prepLeft = updatePose(weightShiftLeft, {
      10: [0.56, 0.72],
      12: [0.54, 0.70],
      16: [0.52, 0.66]
    });
    return def(
      ...
      buttKickLeft,
      STANDING_FRONT,
      mirrorPose(weightShiftLeft),
      mirrorPose(buttKickLeft),
      STANDING_FRONT
    );
  },
  'jump-squats-hiit': () => {
  ...
  'squat-thrusts': () => {
    const halfSquat = updatePose(squatMid, {
      3: [0.40, 0.40],
      4: [0.60, 0.40],
      5: [0.36, 0.48],
      6: [0.64, 0.48]
    ...
    const handsUpSquat = updatePose(burpeeSquat, {
      3: [0.40, 0.44],
      4: [0.60, 0.44],
      5: [0.38, 0.56],
      6: [0.62, 0.56]
    });
    return def('front', STANDING_FRONT, halfSquat, burpeeSquat, handsDown, PLANK_FRONT, handsUpSquat, halfSquat, STANDING_FRONT);
  },
  'plank-jacks-hiit': () => {
  ...
  'lateral-shuffles': () => {
    const shuffleCenter = updatePose(STANDING_FRONT, {
      3: [0.40, 0.40],
      4: [0.60, 0.40],
      5: [0.36, 0.50],
      6: [0.64, 0.50],
    ...
    const loadLeft = updatePose(shuffleCenter, {
      0: [0.48, 0.15],
      1: [0.40, 0.29],
      2: [0.56, 0.29],
      7: [0.43, 0.58],
    ...
    const stepLeft = updatePose(loadLeft, {
      0: [0.45, 0.15],
      1: [0.37, 0.29],
      2: [0.53, 0.29],
      7: [0.40, 0.58],
    ...
    return def('front', shuffleCenter, loadLeft, stepLeft, shuffleCenter, mirrorPose(loadLeft), mirrorPose(stepLeft), shuffleCenter);
  },
  'push-ups-standard': () => {
  ...
  'inchworms': () => {
    const walkoutHalf = updatePose(inchwormFold, {
      3: [0.62, 0.62],
      4: [0.66, 0.62],
      5: [0.60, 0.74],
      6: [0.66, 0.74],
    ...
    return def('side', STANDING_SIDE, inchwormFold, walkoutHalf, inchwormPlank, walkoutHalf, inchwormFold, STANDING_SIDE);
  },
  'shoulder-taps-plank': () => {
    const weightShiftRight = updatePose(PLANK_FRONT, {
      7: [0.47, 0.56],
  ...
  'reverse-snow-angels': () => {
    const snowAngelStartWide = updatePose(PRONE_FLAT, {
      3: [0.38, 0.62],
      4: [0.38, 0.86],
      5: [0.46, 0.60],
      6: [0.46, 0.88]
    });
    return def('side', PRONE_FLAT, snowAngelStartWide, snowAngelWide, snowAngelOverhead, snowAngelWide, snowAngelStartWide, PRONE_FLAT);
  },
  'wall-push-ups': () => {
    const wallStart = updatePose(DESK_PUSHUP, {
      0: [0.74, 0.30],
      1: [0.62, 0.34],
      2: [0.64, 0.32],
      3: [0.56, 0.44],
    ...
    const wallQuarter = updatePose(wallStart, {
      0: [0.70, 0.34],
      1: [0.59, 0.38],
      2: [0.61, 0.36],
      3: [0.53, 0.48],
    ...
    const wallHalf = updatePose(wallStart, {
      0: [0.66, 0.38],
      1: [0.56, 0.42],
      2: [0.58, 0.40],
      3: [0.50, 0.52],
    ...
    const wallFull = updatePose(wallStart, {
      0: [0.62, 0.42],
      1: [0.54, 0.45],
      2: [0.56, 0.43],
      3: [0.48, 0.54],
    ...
    return def('side', wallStart, wallQuarter, wallHalf, wallFull, wallHalf, wallQuarter, wallStart);
  },
  'bodyweight-squats': () => {
  ...
  'sumo-squats': () => {
    const sumoStart = updatePose(WIDE_STANCE_FRONT, {
      3: [0.46, 0.42],
      4: [0.54, 0.42],
      5: [0.48, 0.50],
      6: [0.52, 0.50]
    });
    const sumoQuarter = updatePose(sumoStart, {
      7: [0.42, 0.60],
      8: [0.58, 0.60],
      9: [0.35, 0.76],
      10: [0.65, 0.76],
    ...
    const sumoHalf = updatePose(sumoStart, {
      0: [0.50, 0.17],
      7: [0.42, 0.64],
      8: [0.58, 0.64],
      9: [0.33, 0.80],
    ...
    const sumoDeep = updatePose(sumoStart, {
      0: [0.50, 0.20],
      3: [0.44, 0.44],
      4: [0.56, 0.44],
      5: [0.48, 0.56],
    ...
    return def('front', sumoStart, sumoQuarter, sumoHalf, sumoDeep, sumoHalf, sumoQuarter, sumoStart);
  },
  'forward-lunges': () => {
  ...
  'wall-sit': () => {
    const wallBrace = updatePose(WALL_SIT, {
      3: [0.44, 0.44], 4: [0.52, 0.44],
      5: [0.42, 0.56], 6: [0.54, 0.56]
    });
    const wallTense = updatePose(WALL_SIT, {
      0: [0.46, 0.19], 1: [0.45, 0.31], 2: [0.49, 0.31],
      3: [0.43, 0.45], 4: [0.53, 0.45],
      5: [0.41, 0.58], 6: [0.55, 0.58],
      13: [0.47, 0.31]
    });
    const wallShake = updatePose(WALL_SIT, {
      9: [0.61, 0.73], 10: [0.65, 0.73],
      11: [0.61, 0.90], 12: [0.65, 0.90]
    });
    return def('side', WALL_SIT, wallBrace, wallTense, wallBrace, WALL_SIT, wallShake, WALL_SIT);
  },
  'glute-bridges': () => {
    const bridgeBrace = updatePose(LYING_BACK_KNEES_UP, {
      0: [0.18, 0.68],
  ...
  'single-leg-bridges': () => {
    const singleLegBase = updatePose(LYING_BACK_KNEES_UP, {
      10: [0.68, 0.76],
      12: [0.80, 0.58],
      16: [0.86, 0.50]
    });
    const singleLegBrace = updatePose(singleLegBase, {
      0: [0.18, 0.69],
      13: [0.28, 0.71],
      14: [0.54, 0.71]
    });
    const singleLegQuarter = updatePose(singleLegBase, {
      0: [0.19, 0.72],
      7: [0.54, 0.64],
      8: [0.54, 0.72],
      13: [0.28, 0.74],
    ...
    const singleLegHigh = updatePose(bridgeHigh, {
      10: [0.68, 0.76],
      12: [0.80, 0.58],
      16: [0.86, 0.50]
    });
    const singleLegHold = updatePose(singleLegHigh, {
      0: [0.21, 0.74],
      13: [0.31, 0.76],
      14: [0.55, 0.61]
    });
    const singleLegLower = updatePose(singleLegBase, {
      0: [0.19, 0.73],
      7: [0.54, 0.66],
      8: [0.54, 0.74],
      13: [0.29, 0.75],
    ...
    return def('side', singleLegBase, singleLegBrace, singleLegQuarter, singleLegHigh, singleLegHold, singleLegLower, singleLegBrace, singleLegBase);
  },
  'calf-raises': () => {
  ...
  'donkey-kicks': () => {
    ...
    const donkeyHalfRight = updatePose(HANDS_KNEES, {
      10: [0.44, 0.56],
      12: [0.44, 0.38],
      16: [0.46, 0.30]
    });
    return def('side', HANDS_KNEES, donkeyPrepRight, donkeyHalfRight, donkeyKickRight, HANDS_KNEES, mirrorPose(donkeyHalfRight), mirrorPose(donkeyKickRight), HANDS_KNEES);
  },
  'fire-hydrants': () => {
    const fireHydrantPrepRight = updatePose(HANDS_KNEES, {
      10: [0.42, 0.68],
      12: [0.50, 0.72],
      16: [0.56, 0.74]
    });
    const fireHydrantHalfRight = updatePose(HANDS_KNEES, {
      10: [0.48, 0.62],
      12: [0.60, 0.60],
      16: [0.68, 0.60]
    });
    return def('side', HANDS_KNEES, fireHydrantPrepRight, fireHydrantHalfRight, fireHydrantRight, HANDS_KNEES, mirrorPose(fireHydrantHalfRight), mirrorPose(fireHydrantRight), HANDS_KNEES);
  },
  'side-leg-raises': () => {
    const sideLegPrep = updatePose(STANDING_FRONT, {
      4: [0.63, 0.40],
      6: [0.64, 0.54],
      10: [0.60, 0.70],
      12: [0.62, 0.80],
    ...
    const sideLegQuarter = updatePose(STANDING_FRONT, {
      4: [0.64, 0.39],
      6: [0.66, 0.53],
      10: [0.62, 0.68],
      12: [0.68, 0.72],
    ...
    return def('front', STANDING_FRONT, sideLegPrep, sideLegQuarter, sideLegRaise, sideLegQuarter, sideLegPrep, STANDING_FRONT);
  },
  ...
  'bird-dog': () => {
    const birdDogArmStart = updatePose(HANDS_KNEES, {
      4: [0.52, 0.42],
      6: [0.58, 0.34]
    });
    const birdDogMid = updatePose(HANDS_KNEES, {
      4: [0.52, 0.40],
      6: [0.60, 0.30],
      10: [0.48, 0.60],
      12: [0.58, 0.50],
    ...
    const birdDogHold = updatePose(birdDogRight, {
      0: [0.78, 0.36],
      13: [0.63, 0.41],
      14: [0.56, 0.54]
    });
    return def('side', HANDS_KNEES, birdDogArmStart, birdDogMid, birdDogRight, birdDogHold, birdDogMid, HANDS_KNEES);
  },
  'hollow-hold': () => {
  ...
  'shoulder-stretch': () => {
    const shoulderStretchPrepLeft = updatePose(STANDING_FRONT, {
      3: [0.48, 0.38],
      4: [0.62, 0.38],
      5: [0.54, 0.34],
      6: [0.40, 0.40]
    ...
    return def(
      'front',
      STANDING_FRONT,
      shoulderStretchPrepLeft,
      shoulderStretchLeft,
      STANDING_FRONT,
      mirrorPose(shoulderStretchPrepLeft),
      mirrorPose(shoulderStretchLeft),
      STANDING_FRONT
    );
  },
  'chest-opener': () => {
  ...
  'spinal-twist-lying': () => {
    const spinalTwistMidLeft = updatePose(LYING_BACK_KNEES_UP, {
      3: [0.40, 0.63],
      4: [0.40, 0.77],
      9: [0.66, 0.62],
      10: [0.66, 0.78],
    ...
    return def('side', LYING_BACK_KNEES_UP, spinalTwistMidLeft, spinalTwistLeft, LYING_BACK_KNEES_UP, mirrorPose(spinalTwistMidLeft), spinalTwistRight, LYING_BACK_KNEES_UP);
  },
  ...
  'seated-spinal-twist': () => {
    const seatedTwistPrepLeft = updatePose(SEATED_FRONT, {
      0: [0.48, 0.24],
      1: [0.43, 0.36],
      2: [0.54, 0.34],
      3: [0.41, 0.50],
    ...
    return def('front', SEATED_FRONT, seatedTwistPrepLeft, seatedTwistLeft, SEATED_FRONT, mirrorPose(seatedTwistPrepLeft), seatedTwistRight, SEATED_FRONT);
  },
  'wrist-circles': () => {
  ...
  'desk-push-ups': () => {
    const deskQuarter = updatePose(DESK_PUSHUP, {
      0: [0.70, 0.36],
      1: [0.60, 0.40],
      2: [0.62, 0.38],
      3: [0.52, 0.52],
    ...
    const deskHalf = updatePose(DESK_PUSHUP, {
      0: [0.66, 0.40],
      1: [0.56, 0.44],
      2: [0.58, 0.42],
      3: [0.50, 0.54],
    ...
    const deskFull = updatePose(DESK_PUSHUP, {
      0: [0.62, 0.44],
      1: [0.54, 0.48],
      2: [0.56, 0.46],
      3: [0.48, 0.56],
    ...
    return def('side', DESK_PUSHUP, deskQuarter, deskHalf, deskFull, deskHalf, deskQuarter, DESK_PUSHUP);
  },
  ...
  'bear-crawl': () => {
    const bearCrawlBase = updatePose(HANDS_KNEES, {
      0: [0.74, 0.34],
      7: [0.54, 0.54],
      8: [0.50, 0.52],
      9: [0.44, 0.70],
    ...
    const bearCrawlMidLeft = updatePose(bearCrawlBase, {
      5: [0.42, 0.64],
      6: [0.48, 0.62],
      11: [0.32, 0.82],
      12: [0.30, 0.82]
    });
    return def('side', bearCrawlBase, bearCrawlMidLeft, bearCrawlLeft, bearCrawlBase, mirrorPose(bearCrawlMidLeft), mirrorPose(bearCrawlLeft), bearCrawlBase);
  },
  'plank-to-pushup': () => {
  ...
  'walk-out-pushup': () => {
    const walkoutHalf = updatePose(walkoutFold, {
      3: [0.62, 0.62],
      4: [0.66, 0.62],
      5: [0.60, 0.74],
      6: [0.66, 0.74],
    ...
    return def('side', STANDING_SIDE, walkoutFold, walkoutHalf, pushupTop, pushupBottom, pushupTop, walkoutFold, STANDING_SIDE);
  }
};
